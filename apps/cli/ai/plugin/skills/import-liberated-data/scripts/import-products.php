 ...
 *
 * Usage:
 *   studio wp eval-file import-products.php
 *
 * Environment variables:
 *   IMPORT_CSV_PATH  Path to the products CSV file.
...
$csv_path = getenv( 'IMPORT_CSV_PATH' ) ? getenv( 'IMPORT_CSV_PATH' ) : '/wordpress/wp-content/imports/products.csv';
