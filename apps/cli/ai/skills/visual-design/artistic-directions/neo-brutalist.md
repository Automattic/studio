...
---
Palette: white `#ffffff` ground, black `#000000` outlines, and two or three saturated flats (lime `#c7f464`, hot pink `#ff5ca8`, sky `#7dd3fc`, orange `#ff8a3d`); each section takes one flat as its background.
