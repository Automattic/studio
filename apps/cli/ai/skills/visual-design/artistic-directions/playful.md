---
title: "Playful"
description: "Bright, rounded, and friendly: a white or pale ground, a candy palette of three or four saturated colors, a chunky rounded display face, blob and pill shapes, sticker badges, flat illustrations with thick outlines, and small bouncy motion. Fun for a kids' brand, an ice cream shop, a toy store, or a festival, without tipping into chaos."
---
Palette: ground `#ffffff`, ink `#22223b`, and three or four candy colors — coral `#ff6b6b`, sunflower `#ffd93d`, mint `#6bcb77`, sky `#4d96ff` — each section leading with one and using the others as accents; tints of them at 15% for backgrounds.
