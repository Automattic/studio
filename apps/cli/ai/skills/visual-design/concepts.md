...
Fallback: without scroll-timeline support, on mobile, and under reduced motion the sections render as an ordinary vertical column with the dot rail hidden.
