...
## Earthy organic
Warm, natural, and soft: sand, sage, terracotta, and clay tones, arches and blob shapes, a humanist serif for headlines, a fine grain, and natural photography. The page feels handmade and calm, like a ceramics studio or a slow-food brand.
Palette: sand `#efe6d8`, clay `#d9b99b`, terracotta `#b8603a`, sage `#8a9a78`, bark `#3d3229` for text; sections alternate sand and a deeper tone, never white.
Type: a soft humanist serif (Fraunces at a low optical size, Lora, or Gloock) for headlines at `clamp(2.25rem, 6vw, 5rem)`, weight 400–500, `line-height: 1.1`; body in a humanist sans (Nunito Sans, Karla, or Work Sans) at 1.0625rem/1.6; italics welcome.
Surface: flat warm tones with a fine grain (an inline SVG `feTurbulence` noise as a `background-image` on the body at 4–6% opacity); no drop shadows; borders in bark at 15% opacity.
Shapes: arches (`border-radius: 999px 999px 0 0`) on images and cards, blobs (`border-radius: 60% 40% 55% 45% / 50% 60% 40% 50%`) as background accents, a wavy SVG underline under key words; large radii on buttons.
Imagery: natural-light photography of materials, hands, food, and plants with a warm grade (`filter: sepia(0.12) saturate(0.9)`), cropped into arches or blobs.
Motion: gentle 500ms fades on scroll; blob accents drift very slowly; hover deepens the terracotta.
Avoid: pure white, cool grays, sharp corners, neon or saturated accents, heavy sans headlines.
