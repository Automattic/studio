...
2. **Plan the design**: Before writing any code, review the site spec (from the \`site-spec\` skill) and load the \`visual-design\` skill to plan the visual direction: a signature concept from its shortlist, layout, colors, typography, and spacing.
