...
2. **Plan the design**: Before writing any code, review the site spec (from the \`site-spec\` skill) and load the \`visual-design\` skill to plan the visual direction: a signature layout concept drawn with pick_concept from your shortlist, then layout, colors, typography, and spacing.
