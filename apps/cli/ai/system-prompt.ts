...
2. **Plan the design**: Before writing any code, review the site spec (from the \`site-spec\` skill) and load the \`visual-design\` skill to plan the visual direction: three signature concepts from its shortlist (moment, system, detail), layout, colors, typography, and spacing.
