...
const backgroundSvg = (
	...
	>
		<style>
			{ `
				.sds-accent { fill: var(--color-frame-theme); fill-opacity: 0.2; }
				.sds-frame { fill: var(--color-frame-surface); }
				.sds-toolbar { fill: var(--color-frame-surface-alt); }
				.sds-arrow { fill: var(--color-frame-text-secondary); }
				@media (prefers-color-scheme: dark) {
					.sds-accent { fill-opacity: 0.35; }
				}
			` }
		</style>
		<path
