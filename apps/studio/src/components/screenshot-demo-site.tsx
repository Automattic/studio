...
const backgroundSvg = (
	...
	>
		<style>
			{ `
				.preview-accent { fill: var(--color-frame-theme); fill-opacity: 0.2; }
				.preview-frame { fill: #F6F7F7; }
				.preview-toolbar { fill: #DCDCDE; }
				.preview-arrow { fill: #787C82; }
				@media (prefers-color-scheme: dark) {
					.preview-accent { fill-opacity: 0.35; }
					.preview-frame { fill: #2C3338; }
					.preview-toolbar { fill: #50575E; }
					.preview-arrow { fill: #A7AAAD; }
				}
			` }
		</style>
		<path
