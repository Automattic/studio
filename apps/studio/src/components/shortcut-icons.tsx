/**
 * App icons for the "Open in…" shortcuts.
 * Sourced from Simple Icons (https://simpleicons.org) where available.
 */

/* Finder (macOS) — folder icon */
...
/* File Explorer (Windows) — folder icon variant */
export const FileExplorerIcon = FinderIcon;
...
/* Antigravity (Google) — generic code brackets as fallback */
...
/* Terminal (default / Command Prompt) */
...
/** Map editor/terminal identifiers to their icon components. */
export const editorIcons: Record< string, () => JSX.Element > = {
	vscode: VSCodeIcon,
	cursor: CursorIcon,
...
export const terminalIcons: Record< string, () => JSX.Element > = {
