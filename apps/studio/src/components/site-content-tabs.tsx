...
export function SiteContentTabs() {
	...
	if ( enableWorkspaces && selectedWpcomSite ) {
		return (
			<div className="flex h-full min-h-0 w-full app-no-drag-region overflow-hidden">
	...
	return (
		<div className="w-full h-full flex flex-col pt-8 overflow-y-auto app-no-drag-region">
			<Header />
			<TabPanel
