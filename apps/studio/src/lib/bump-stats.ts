...
export enum StatsGroup {
	...
	APP_STUDIO_CODE_SEND = 'app-studio-code-send',
	APP_STUDIO_CODE_RUN = 'app-studio-code-run',
	APP_STUDIO_CODE_WKLY_UNQ = 'app-studio-code-wk-unq',
	APP_STUDIO_CODE_MON_UNQ = 'app-studio-code-mon-unq',
}
