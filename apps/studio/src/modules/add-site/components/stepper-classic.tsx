...
import { useStepperClassic } from '../hooks/use-stepper-classic';
...
export default function StepperClassic( {
	currentPath,
	onBack,
	onBlueprintContinue,
	...
	const { __ } = useI18n();
	const { steps, isVisible, actionButton, onSubmit, canSubmit } = useStepperClassic( {
		onBlueprintContinue,
		onBlueprintDetailsContinue,
		onBlueprintDeeplinkContinue,
		onBackupContinue,
