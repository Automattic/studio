...
import { type ClassicAddSiteFlowType } from '../components/options-classic';
...
export function useStepperClassic( config?: StepperConfig ): UseStepper {
	const { __ } = useI18n();
