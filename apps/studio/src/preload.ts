...
const api: IpcApi = {
	...
	saveMessageSendShortcut: ( shortcut ) => ipcRendererInvoke( 'saveMessageSendShortcut', shortcut ),
	getMessageSendShortcut: () => ipcRendererInvoke( 'getMessageSendShortcut' ),
	saveWpAdminOpenTarget: ( target ) => ipcRendererInvoke( 'saveWpAdminOpenTarget', target ),
	getWpAdminOpenTarget: () => ipcRendererInvoke( 'getWpAdminOpenTarget' ),
