...
// Once every item completes, celebrate briefly and then hide the card.
...
function MinimizedBar( { message }: { message: ChecklistMessage } ) {
			...
			<div className={ styles.headerControls }>
				<Menu.Root modal={ false }>
					...
					<Menu.Popup side="bottom" align="end">
						...
						<Menu.Item onClick={ onDismiss }>{ __( 'Hide' ) }</Menu.Item>
					</Menu.Popup>
				</Menu.Root>
				<IconButton
					size="small"
