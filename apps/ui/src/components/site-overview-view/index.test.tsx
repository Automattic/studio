...
vi.mock( '@/components/site-dropdown', () => ( {
	SiteDropdown: () => <button type="button">Site menu</button>,
} ) );
...
describe( 'SiteOverviewView', () => {
	...
	it( 'shows a compact active empty state that can start a new chat', () => {
		useSessionsMock.mockReturnValue( {
			data: [
				{
					id: 'archived-session',
	...
	it( 'does not render the browser toggle button in the details view', () => {
		renderOverview();
