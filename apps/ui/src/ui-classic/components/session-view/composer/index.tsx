...
function loadImageElement( src: string ): Promise< HTMLImageElement | undefined > {
...
export const Composer = forwardRef< ComposerHandle, ComposerProps >( function Composer(
	...
	const createAttachment = useCallback(
		async ( file: File ): Promise< ComposerImageAttachment > => {
			...
			const imageElement = await loadImageElement( previewUrl );
			const attachment: ComposerImageAttachment = {
				...
				previewDataUrl: imageElement && createPreviewDataUrl( imageElement, mimeType ),
				dataBase64,
				previewUrl,
			};
