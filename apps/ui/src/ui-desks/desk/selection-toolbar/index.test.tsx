...
function createDeskContext( overrides: Partial< DeskContextValue > = {} ): DeskContextValue {
	return {
		...
		startAnnotatingPreview: vi.fn(),
		stopAnnotatingPreview: vi.fn(),
		requestAnnotation: vi.fn(),
		confirmPendingAnnotation: vi.fn(),
		cancelPendingAnnotation: vi.fn(),
		removeSelectedAnnotation: vi.fn(),
		collectAnnotationSubmission: vi.fn(),
		...overrides,
	};
}
