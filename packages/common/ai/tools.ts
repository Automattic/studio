...
export function getToolDisplayName( name: string, input?: Record< string, unknown > ): string {
	...
	const displayNames: Record< string, string > = {
		...
		design_project_status: __( 'Read design project' ),
		design_artifact_finalize: __( 'Add design direction' ),
		design_artifact_accept: __( 'Accept design' ),
		materialize_design_artifact: __( 'Build WordPress site' ),
