 ...
 * Description: Image-left, headline+subhead+CTA-right hero. Most common e-commerce / SaaS hero shape.
 *
...
<p class="has-text-muted-color has-text-color" style="font-size:1.125rem;line-height:1.6">{{SUBHEAD}}</p>
<!-- /wp:paragraph -->
