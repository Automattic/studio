 ...
 * @studio/addon-api
 *
 * Stable public contract for WordPress Studio addons.
 * This file contains only TypeScript interfaces — no Electron runtime imports.
 * Addon authors should depend on this package for full type safety.
 */
