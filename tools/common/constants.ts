...
export const PUBLISHING_CONFIG_LOCKFILE_NAME = 'publishing.json.lock';
export const DEVELOPMENT_CHAT_STATE_DIRECTORY_NAME = 'development-chats';
export const WORDPRESS_ORG_STORAGE_STATE_LOCKFILE_NAME = 'wordpress-org-storage.json.lock';
